...
--
-- Host: 127.0.0.1
-- Generation Time: Maj 23, 2025 at 12:06 AM
...
CREATE TABLE `character` (
  ...
  `game_currency` int(10) UNSIGNED NOT NULL DEFAULT 0,
  ...
  `stat_bought_stamina` mediumint(9) NOT NULL,
  `stat_bought_strength` mediumint(9) NOT NULL,
  `stat_bought_critical_rating` mediumint(9) NOT NULL,
  `stat_bought_dodge_rating` mediumint(9) NOT NULL,
  ...
  `stat_trained_stamina` mediumint(9) NOT NULL,
  `stat_trained_strength` mediumint(9) NOT NULL,
  `stat_trained_critical_rating` mediumint(9) NOT NULL,
  `stat_trained_dodge_rating` mediumint(9) NOT NULL,
  `training_progress_value_stamina` smallint(6) NOT NULL,
  `training_progress_value_strength` mediumint(9) NOT NULL,
  `training_progress_value_critical_rating` mediumint(9) NOT NULL,
  `training_progress_value_dodge_rating` mediumint(9) NOT NULL,
  ...
  `appearance_skin_color` tinyint(4) NOT NULL,
  `appearance_hair_color` tinyint(4) NOT NULL,
  `appearance_hair_type` tinyint(4) NOT NULL,
  `appearance_head_type` tinyint(4) NOT NULL,
  `appearance_eyes_type` tinyint(4) NOT NULL,
  `appearance_eyebrows_type` tinyint(4) NOT NULL,
  `appearance_nose_type` tinyint(4) NOT NULL,
  `appearance_mouth_type` tinyint(4) NOT NULL,
  `appearance_facial_hair_type` tinyint(4) NOT NULL,
  `appearance_decoration_type` tinyint(4) NOT NULL DEFAULT 1,
  `show_mask` tinyint(1) NOT NULL DEFAULT 1,
  `tutorial_flags` text NOT NULL,
  `guild_id` int(11) NOT NULL,
  `guild_rank` tinyint(4) NOT NULL,
  ...
  `daily_login_bonus_day` tinyint(4) NOT NULL DEFAULT 1,
  ...
  `active_duel_id` int(11) NOT NULL,
  ...
  `current_goal_values` mediumtext NOT NULL,
  `collected_goals` mediumtext NOT NULL,
  `current_item_pattern_values` mediumtext NOT NULL,
  `collected_item_pattern` mediumtext NOT NULL,
  `owned_item_templates` mediumtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `dungeons` (
  ...
  `progress_index` tinyint(4) NOT NULL DEFAULT 1,
...
CREATE TABLE `dungeon_quests` (
  `id` int(11) NOT NULL,
  `character_id` int(11) NOT NULL,
  `character_level` tinyint(4) NOT NULL DEFAULT 0,
  `identifier` varchar(32) NOT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 1,
  `battle_id` int(11) NOT NULL,
...
CREATE TABLE `goal_items` (
  ...
  `buy_price` mediumint(9) NOT NULL,
  `sell_price` mediumint(9) NOT NULL,
  ...
  `stat_weapon_damage` mediumint(9) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `guild` (
  ...
  `arena_background` smallint(6) NOT NULL DEFAULT 1,
  `emblem_background_shape` tinyint(4) NOT NULL DEFAULT 1,
  `emblem_background_color` tinyint(4) NOT NULL DEFAULT 2,
  `emblem_background_border_color` tinyint(4) NOT NULL,
  `emblem_icon_shape` tinyint(4) NOT NULL DEFAULT 1,
  `emblem_icon_color` tinyint(4) NOT NULL DEFAULT 4,
  `emblem_icon_size` smallint(6) NOT NULL DEFAULT 100,
...
CREATE TABLE `pattern_items` (
  ...
  `character_id` int(11) NOT NULL,
  `identifier` varchar(100) NOT NULL,
  `pattern_identifier` text NOT NULL,
  `type` tinyint(4) NOT NULL,
  `quality` tinyint(4) NOT NULL,
  `required_level` smallint(6) NOT NULL,
  `charges` tinyint(4) NOT NULL,
...
CREATE TABLE `quests` (
  ...
  `fight_difficulty` tinyint(4) NOT NULL DEFAULT 0,
  `fight_npc_identifier` varchar(60) NOT NULL,
  `fight_battle_id` int(11) NOT NULL DEFAULT 0,
  `used_resources` tinyint(4) NOT NULL DEFAULT 0,
  `rewards` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `sidekicks` (
  ...
  `stat_critical_rating` mediumint(9) NOT NULL,
  `stat_dodge_rating` mediumint(9) NOT NULL,
  `stage1_skill_id` mediumint(9) NOT NULL,
  `stage2_skill_id` mediumint(9) NOT NULL,
  `stage3_skill_id` mediumint(9) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
--
-- AUTO_INCREMENT for table `pattern_items`
--
ALTER TABLE `pattern_items`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
