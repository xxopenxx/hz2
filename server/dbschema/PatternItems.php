...
class PatternItems extends Record implements JsonSerializable{
    protected static $_TABLE = 'pattern_items';
    
    
    public function getMissileDamage(){
        $_loc2_ = GameSettings::getConstant('item_missile_damage_factor');
